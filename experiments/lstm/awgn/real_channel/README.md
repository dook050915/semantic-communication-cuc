...
本版高 SNR 的 BLEU(channel_dim=128 约 0.16)低于之前 latent-noise 版(约 0.23),但这不是退步,原因有二。其一,之前 cell 是干净旁路,接近无噪信道,BLEU 自然偏高;其二,本版多了信道编解码的有损瓶颈(1024 维压到 channel_dim 再还原)。两者都是真信道的代价,本版才符合现实通信设定。
